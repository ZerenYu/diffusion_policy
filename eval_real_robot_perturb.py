            ...
            while True:
                ...
                try:
                    ...
                    while True:
                        ...
                        curr_time = time.time()
                        print(f"[zyu] action_timestamps: {action_timestamps}")
                        is_new = action_timestamps > (curr_time + action_exec_latency)
                        print(f"[zyu] is_new: {is_new}")
                        if np.sum(is_new) == 0:
                        ...
                        print(f"[zyu] this_target_poses: {this_target_poses}")
                        print(f"this_target_poses shape: {this_target_poses.shape}")
                        ...
                        print(f"[zyu] curr_pose: {curr_pose}")
